# The Price of Risk When Aggregation Fails

Replication package for *The Price of Risk When Aggregation Fails: Relative
Wealth Concerns with Heterogeneous Risk Aversion* (Renato Vicente, Instituto de
Matemática, Estatística e Ciência da Computação, Universidade de São Paulo).
